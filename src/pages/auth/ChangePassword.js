import { Box, TextField, Button, Alert, Typography, CircularProgress, Grid } from '@mui/material';
      ...
      <Grid item sm={6} xs={12}>
        ...
        <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }} id="password-change-form">
          ...
          <Box textAlign='center'>
            ...
            {isLoading ? <CircularProgress /> : <Button type='submit' variant='contained' sx={{ mt: 2, mb: 2, px: 5 }}>Update</Button>}
